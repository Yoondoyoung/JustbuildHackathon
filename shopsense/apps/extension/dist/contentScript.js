const y=(e,t=document)=>{var n;for(const i of e){const o=t.querySelector(i),l=(n=o==null?void 0:o.textContent)==null?void 0:n.trim();if(l)return l}},k=e=>{var t;for(const n of e){const i=document.querySelector(`meta[name="${n}"], meta[property="${n}"]`),o=(t=i==null?void 0:i.getAttribute("content"))==null?void 0:t.trim();if(o)return o}},M=e=>{if(!e)return;const t=e.replace(/[^0-9.]/g,""),n=Number(t);return Number.isFinite(n)?n:void 0},D=e=>{if(!e)return;const t=e.replace(/,/g,"").match(/(\d+(\.\d+)?)/);return t?M(t[1]):void 0},j=(e,t="USD")=>e?e.includes("£")?"GBP":e.includes("€")?"EUR":e.includes("¥")?"JPY":e.includes("₩")?"KRW":e.includes("$")?"USD":t:t,Z=e=>e.replace(/[:：]\s*$/,"").trim(),U=(e,t,n)=>{const i=t?Z(t):"",o=(n==null?void 0:n.trim())??"";!i||!o||e[i]||(e[i]=o)},H=(e,t)=>{e.querySelectorAll("table").forEach(n=>{n.querySelectorAll("tr").forEach(i=>{var o,l;U(t,(o=i.querySelector("th"))==null?void 0:o.textContent,(l=i.querySelector("td"))==null?void 0:l.textContent)})}),e.querySelectorAll("dl").forEach(n=>{Array.from(n.querySelectorAll("dt")).forEach(o=>{var l;U(t,o.textContent,(l=o.nextElementSibling)==null?void 0:l.textContent)})}),e.querySelectorAll("li").forEach(n=>{const i=n.querySelector("span.a-text-bold, strong, b");if(!i)return;const o=i.textContent??"",l=Z(o);if(!l)return;const a=(n.textContent??"").replace(o,"").replace(/^[\s:-]+/,"").trim();U(t,l,a)})},V=(e=document)=>{const t={};return H(e,t),Object.keys(t).length>0?t:void 0},ee=["[itemprop=review]","[data-hook=review]",".review",".reviews-list .review-item","[data-testid=review-card]",".ugc-review-body"],$=(e=ee,t=document)=>{const n=[];return t.querySelectorAll(e.join(",")).forEach(i=>{var l;if(n.length>=5)return;const o=(l=i.textContent)==null?void 0:l.trim();o&&o.length>20&&n.push(o.replace(/\s+/g," "))}),n.length>0?n:void 0},te=()=>{var c;const e=k(["og:title","twitter:title"])||y(["h1","[itemprop=name]","[data-test=product-title]"])||document.title,t=k(["product:brand","og:brand"])||y(["[itemprop=brand]","[data-brand]",".brand",".product-brand"]),n=k(["product:mpn","product:model"])||y(["[itemprop=mpn]","[data-model]"]),i=k(["product:price:amount","price","og:price:amount"])||y(["[itemprop=price]","[data-test=product-price]",".price"]),o=k(["product:price:currency","price:currency"])||((c=document.querySelector("[itemprop=priceCurrency]"))==null?void 0:c.getAttribute("content"))||j(i,"USD"),l=k(["rating","ratingValue"])||y(["[itemprop=ratingValue]","[data-test=rating]",".rating"]),r=k(["reviewCount"])||y(["[itemprop=reviewCount]","[data-hook=total-review-count]",".review-count"]),a=M(i);return{title:e,brand:t,model:n,price:a!==void 0?{value:a,currency:o}:void 0,rating:D(l),review_count:M(r),key_specs:V(),visible_reviews:$()}},ie=e=>e&&e.replace(/^Brand:\s*/i,"").replace(/^Visit the\s*/i,"").replace(/\s*Store$/i,"").trim()||void 0,ne=()=>{const e={};["#productDetails_techSpec_section_1","#productDetails_detailBullets_sections1","#technicalSpecifications_feature_div","#detailBullets_feature_div","#detailBulletsWrapper_feature_div","#prodDetails"].forEach(i=>{const o=document.querySelector(i);o&&H(o,e)});const n=V();return n&&Object.entries(n).forEach(([i,o])=>{e[i]||(e[i]=o)}),Object.keys(e).length>0?e:void 0},oe=()=>y(["#mir-layout-DELIVERY_BLOCK-slot-PRIMARY_DELIVERY_MESSAGE_LARGE","#mir-layout-DELIVERY_BLOCK-slot-DELIVERY_MESSAGE","#deliveryMessageMirId","#deliveryMessage","#mir-layout-DELIVERY_BLOCK-slot-PRIMARY_DELIVERY_MESSAGE_SMALL"]),re=()=>{const e=y(["#productTitle","h1#title"]),t=document.querySelector("#bylineInfo"),n=ie((t==null?void 0:t.getAttribute("aria-label"))??(t==null?void 0:t.textContent)??""),i=y(["#corePrice_feature_div .a-offscreen","#apex_desktop .a-price .a-offscreen","#priceblock_ourprice","#priceblock_dealprice","#priceblock_saleprice"])??k(["product:price:amount","price","og:price:amount"]),o=M(i),l=k(["product:price:currency","price:currency"])||j(i,"USD"),r=document.querySelector("#acrPopover"),a=(r==null?void 0:r.getAttribute("title"))||(r==null?void 0:r.textContent)||y(["#averageCustomerReviews .a-icon-alt","span[data-hook=rating-out-of-text]"]),c=y(["#acrCustomerReviewText","span[data-hook=total-review-count]"]),d=ne(),m=(d==null?void 0:d["Item model number"])||(d==null?void 0:d.Model)||y(["[itemprop=mpn]"]);return{title:e,brand:n,model:m,price:o!==void 0?{value:o,currency:l}:void 0,rating:D(a),review_count:M(c),key_specs:d,visible_reviews:$(["[data-hook=review-body]",".review-text","[data-hook=review]"]),shipping_returns:oe()}},se=()=>{var r;const e={},t=document.querySelector('[data-testid="brix-sheet"]');t&&t.querySelectorAll('div.inline-flex.w-full, div[class*="inline-flex"][class*="w-full"], div[class*="dB7j8sHUbncyf79K"]').forEach(c=>{var u,f;const d=c.querySelector('div.font-weight-medium, div[class*="font-weight-medium"]'),m=c.querySelector('div[class*="pl-300"], div.grow.basis-none[class*="pl-300"]');if(d&&m){const C=d.cloneNode(!0);C.querySelectorAll("button").forEach(T=>T.remove());let g=((u=C.textContent)==null?void 0:u.trim())||"";const b=((f=m.textContent)==null?void 0:f.trim())||"";g=g.replace(/\s+/g," ").trim(),g&&b&&g.length>0&&b.length>0&&(e[g]=b)}});const n=document.querySelectorAll("h2.h5");let i=null;for(const a of Array.from(n))if(((r=a.textContent)==null?void 0:r.trim())==="Highlights"){i=a;break}if(i){const a=i.parentElement;a&&a.querySelectorAll("button.c-button-unstyled").forEach(d=>{var u,f,C;const m=d.querySelector("div.flex.flex-column");if(m){const h=m.querySelector("div:first-child"),g=m.querySelector('div.font-500, div[class*="font-500"]');if(h&&g){const b=h.cloneNode(!0);b.querySelectorAll("svg").forEach(q=>q.remove());let v=((u=b.textContent)==null?void 0:u.trim())||"",s=((f=g.textContent)==null?void 0:f.trim())||"";const x=g.cloneNode(!0);x.querySelectorAll("svg").forEach(q=>q.remove()),s=((C=x.textContent)==null?void 0:C.trim())||"",v=v.replace(/\s+/g," ").trim(),s=s.replace(/\s+/g," ").trim(),v&&s&&v.length>0&&s.length>0&&(e[v]||(e[v]=s))}}})}["#specifications",".specifications",".specification-table",".product-data"].forEach(a=>{const c=document.querySelector(a);c&&H(c,e)});const l=V();return l&&Object.entries(l).forEach(([a,c])=>{e[a]||(e[a]=c)}),Object.keys(e).length>0?e:void 0},ae=()=>{var r,a,c,d;const e=document.querySelector('[data-component-name="FulfillmentSelector"]');if(!e)return y([".fulfillment-additional-info",".availabilityMessage",".fulfillment-fulfillment-summary"]);const t=[],n=e.querySelector('button[data-test-id="pickup"]');if(n){const u=(n.getAttribute("aria-label")||"").match(/(?:Ready on|Pickup)\s+([^,]+,\s*[^,]+)/i);if(u)t.push(`Pickup: ${u[1]}`);else{const f=(a=(r=n.querySelector("strong"))==null?void 0:r.textContent)==null?void 0:a.trim();f&&t.push(`Pickup: ${f}`)}}const i=e.querySelector('button[data-test-id="shipping"]');if(i){const u=(i.getAttribute("aria-label")||"").match(/(?:Get it by|Shipping)\s+([^,]+,\s*[^,]+)/i);if(u)t.push(`Shipping: ${u[1]}`);else{const f=(d=(c=i.querySelector("strong"))==null?void 0:c.textContent)==null?void 0:d.trim();f&&t.push(`Shipping: ${f}`)}}const l=(e.textContent||"").match(/Order now for pickup on ([^a]+) at\s+([^<]+)/i);return l&&t.push(`Pickup location: ${l[2].trim()}`),t.length>0?t.join(" - "):void 0},ce=()=>{var f,C,h,g,b,T;const e=y([".sku-title h1","h1.sku-title","h1"]);let t;const n=document.querySelector('[data-component-name="ProductHeader"]');if(n){const v=n.querySelector(".description a");t=(f=v==null?void 0:v.textContent)==null?void 0:f.trim()}let i;if(n){const v=n.querySelector(".disclaimer");if(v){const x=(v.textContent||"").match(/Model:\s*([^\s]+)/i);x&&(i=x[1])}}let o;const l=document.querySelector('[data-testid="price-block-customer-price"]');l&&(o=(C=l.textContent)==null?void 0:C.trim()),o||(o=y([".priceView-hero-price span",".priceView-customer-price span","[data-testid=customer-price]",".pricing-price__regular-price"])??k(["product:price:amount","price","og:price:amount"]));const r=M(o),a=k(["product:price:currency","price:currency"])||j(o,"USD");let c,d;const m=document.querySelector('[data-component-name="ReviewStatsContextualized"]');if(m){const v=m.querySelector("span.font-weight-bold");if(c=(h=v==null?void 0:v.textContent)==null?void 0:h.trim(),!c){const w=(((g=m.querySelector("p.visually-hidden"))==null?void 0:g.textContent)||"").match(/Rating\s+(\d+(?:\.\d+)?)\s+out\s+of/i);w&&(c=w[1])}const s=m.querySelector("span.c-reviews"),E=(((b=s==null?void 0:s.textContent)==null?void 0:b.trim())||"").match(/(\d+)\s*review/i);if(E&&(d=E[1]),!d){const w=(((T=m.querySelector("p.visually-hidden"))==null?void 0:T.textContent)||"").match(/(\d+)\s+review/i);w&&(d=w[1])}}c||(c=y([".c-review-average",".ugc-c-review-average","[data-automation=overall-rating]"])),d||(d=y([".c-review-count",".ugc-c-review-count","[data-automation=review-count]"]));const u=se();return t=t||(u==null?void 0:u.Brand)||(u==null?void 0:u["Brand Name"]),i=i||(u==null?void 0:u.Model)||(u==null?void 0:u["Model Number"]),{title:e,brand:t,model:i,price:r!==void 0?{value:r,currency:a}:void 0,rating:D(c),review_count:M(d),key_specs:u,visible_reviews:$(["[data-component-name=CustomerReviewListSection] #review-list li p","#review-list li p","[data-testid=enhanced-review-content]","[data-testid=review-card]",".ugc-review-body",".review-text",".review-item"]),shipping_returns:ae()}},le=()=>{const e={};["[data-testid=specifications-section]","[data-testid=product-specifications]","#product-specifications","#specifications"].forEach(i=>{const o=document.querySelector(i);o&&H(o,e)});const n=V();return n&&Object.entries(n).forEach(([i,o])=>{e[i]||(e[i]=o)}),Object.keys(e).length>0?e:void 0},de=()=>{var c,d,m;const e=document.querySelector("#fulfillment-Shipping-content");if(!e)return;const t=[],n=e.querySelector('[data-seo-id="fulfillment-shipping-intent"]'),i=(c=n==null?void 0:n.textContent)==null?void 0:c.trim();i&&t.push(i);const o=n==null?void 0:n.nextElementSibling,l=(d=o==null?void 0:o.textContent)==null?void 0:d.trim();l&&l!==i&&t.push(l);const r=e.querySelector(".f7.b.green, .f7.b"),a=(m=r==null?void 0:r.textContent)==null?void 0:m.trim();return a&&t.push(a),t.length>0?t.join(" - "):void 0},pe=()=>{const e=[];return document.querySelectorAll('[data-testid="enhanced-review-content"]').forEach(n=>{var a,c;if(e.length>=5)return;const i=n.querySelector("h3"),o=((a=i==null?void 0:i.textContent)==null?void 0:a.trim())||"",l=n.querySelector('p[tabindex="-1"]'),r=((c=l==null?void 0:l.textContent)==null?void 0:c.trim())||"";if(r&&r.length>20){const d=o?`${o}. ${r}`:r;e.push(d.replace(/\s+/g," "))}}),e.length>0?e:void 0},ue=()=>{var m,u,f;const e=y(["[data-testid=product-title]","h1","[itemprop=name]"]),t=y(["[data-testid=brand-name]","[itemprop=brand]","a[data-testid=brand-name]","[data-automation-id=brand-name]"]),n=y(["[data-testid=price-wrap] [itemprop=price]","[data-testid=price-wrap]","[data-testid=price]","[itemprop=price]","[data-automation-id=product-price]"])??k(["product:price:amount","price","og:price:amount"]),i=M(n),o=k(["product:price:currency","price:currency"])||j(n,"USD"),l=document.querySelector('[data-testid="reviews-and-ratings"]');let r,a;if(l){const C=l.querySelector("span.w_iUH7");if(C){const h=((m=C.textContent)==null?void 0:m.trim())||"",g=h.match(/(\d+\.?\d*)\s*stars?/i);g&&(r=g[1]);const b=h.match(/(\d+(?:,\d+)?)\s*reviews?/i);b&&(a=b[1])}if(!r){const h=l.querySelector("span.f7"),b=(((u=h==null?void 0:h.textContent)==null?void 0:u.trim())||"").match(/\((\d+\.?\d*)\)/);b&&(r=b[1])}if(!a){const h=l.querySelector('[itemprop="ratingCount"]'),b=(((f=h==null?void 0:h.textContent)==null?void 0:f.trim())||"").match(/(\d+(?:,\d+)?)/);b&&(a=b[1])}}r||(r=y(["[data-testid=reviews-rating]","[itemprop=ratingValue]",".stars-container"])),a||(a=y(["[data-testid=reviews-header]","[data-testid=reviews-count]","[itemprop=reviewCount]",".stars-reviews-count"]));const c=le(),d=(c==null?void 0:c.Model)||(c==null?void 0:c["Model Number"]);return{title:e,brand:t,model:d,price:i!==void 0?{value:i,currency:o}:void 0,rating:D(r),review_count:M(a),key_specs:c,visible_reviews:pe()||$(["[data-testid=review-card]","[data-testid=review-text]","[data-testid=review-body]",".review-text",".prod-ProductReview",".review-body","[data-automation-id=review-text]","section[data-testid=reviews-section] [data-testid=review-card]"]),shipping_returns:de()}},me=e=>{const t=e.toLowerCase();return t.includes("amazon.")?re:t.includes("walmart.")?ue:t.endsWith("bestbuy.com")?ce:null},fe=(e,t)=>{var i;const n={...e.key_specs??{},...t.key_specs??{}};return{page_url:location.href,store_domain:location.host,title:t.title??e.title,brand:t.brand??e.brand,model:t.model??e.model,price:t.price??e.price,rating:t.rating??e.rating,review_count:t.review_count??e.review_count,key_specs:Object.keys(n).length>0?n:void 0,visible_reviews:(i=t.visible_reviews)!=null&&i.length?t.visible_reviews:e.visible_reviews,shipping_returns:t.shipping_returns??e.shipping_returns}},he=()=>{const e=te(),t=me(location.host),n=t?t():{};return fe(e,n)},Q="shopsense-sidebar";let G=null,N=null,K=null,Y=null,I=null,z=null,p=null;const ye=async()=>{try{const e=await chrome.runtime.sendMessage({type:"GET_TAB_ID"});if(typeof(e==null?void 0:e.tabId)=="number")return e.tabId}catch{}return null},P=e=>{if(!K||!N)return;K.textContent=e,N.classList.remove("busy","error");const t=e.toLowerCase();t.includes("fail")||t.includes("error")?N.classList.add("error"):(t.includes("analyz")||t.includes("send"))&&N.classList.add("busy")},be=(e,t)=>{var o,l;e.innerHTML="";const n=document.createElement("h2");n.textContent=t.title??"Analyze",e.appendChild(n);const i=document.createElement("p");if(i.textContent=t.summary??"No summary available.",e.appendChild(i),t.price){const r=document.createElement("div");r.className="meta-row",r.textContent=`Price: ${t.price.value} ${t.price.currency}`,e.appendChild(r)}if(t.rating!==void 0){const r=document.createElement("div");r.className="meta-row",r.textContent=`Rating: ${t.rating}`,e.appendChild(r)}if(t.review_count!==void 0){const r=document.createElement("div");r.className="meta-row",r.textContent=`Reviews: ${t.review_count}`,e.appendChild(r)}if((o=t.key_points)!=null&&o.length){const r=document.createElement("ul");t.key_points.forEach(a=>{const c=document.createElement("li");c.textContent=a,r.appendChild(c)}),e.appendChild(r)}if(t.specs&&Object.keys(t.specs).length>0){const r=document.createElement("div");r.className="specs",Object.entries(t.specs).forEach(([a,c])=>{const d=document.createElement("div");d.className="spec-row",d.textContent=`${a}: ${c}`,r.appendChild(d)}),e.appendChild(r)}if((l=t.citations)!=null&&l.length){const r=document.createElement("div");r.className="citations",t.citations.forEach(a=>{const c=document.createElement("a");c.href=a.url,c.target="_blank",c.rel="noreferrer",c.textContent=a.title??a.url,r.appendChild(c)}),e.appendChild(r)}},J=(e,t)=>{var o;const n=document.createElement("div");n.className=`chat-message ${t.role}`;const i=document.createElement("div");if(i.className="chat-text",i.textContent=t.content,n.appendChild(i),(o=t.citations)!=null&&o.length){const l=document.createElement("div");l.className="chat-citations",t.citations.forEach(r=>{const a=document.createElement("a");a.href=r.url,a.target="_blank",a.rel="noreferrer",a.textContent=r.title??r.url,l.appendChild(a)}),n.appendChild(l)}e.appendChild(n),e.scrollTop=e.scrollHeight},X=()=>{if(p)return;const e=document.getElementById(Q);if(e){p=e;return}const t=document.createElement("div");t.id=Q,t.style.position="fixed",t.style.top="16px",t.style.right="16px",t.style.left="auto",t.style.bottom="auto",t.style.margin="0",t.style.transform="none",t.style.width="340px",t.style.height="calc(100vh - 32px)",t.style.zIndex="2147483647",t.style.display="none";const n=t.attachShadow({mode:"open"});n.innerHTML=`
    <style>
      :host { all: initial; }
  ...
  `,document.documentElement.appendChild(t),p=t,N=n.querySelector("#ss-status-dot"),K=n.querySelector("#ss-status-text"),Y=n.querySelector("#ss-analyze"),I=n.querySelector("#ss-chat"),z=n.querySelector("#ss-chat-input");const i=n.querySelector("#ss-auth-container"),o=n.querySelector("#ss-main-content"),l=n.querySelector("button#ss-analyze"),r=n.querySelector("#ss-chat-form"),a=n.querySelector("#ss-settings-btn"),c=n.querySelector("#ss-minimize-btn"),d=n.querySelector("#ss-sidebar"),m=async()=>{try{const s=await chrome.runtime.sendMessage({type:"CHECK_AUTH"});if(s!=null&&s.isAuthenticated){const x=await chrome.runtime.sendMessage({type:"CHECK_PREFERENCES"});x!=null&&x.hasPreferences?C():f()}else u()}catch(s){console.error("Auth check failed:",s),u()}},u=()=>{i.style.display="flex",o.style.display="none",i.innerHTML=`
    ...
    `;let s="login";const x=i.querySelector('[data-mode="login"]'),E=i.querySelector('[data-mode="signup"]'),q=i.querySelector("#ss-auth-form"),w=i.querySelector("#ss-auth-email"),L=i.querySelector("#ss-auth-password"),S=i.querySelector("#ss-auth-error"),A=i.querySelector("#ss-auth-submit"),R=_=>{s=_,x.classList.toggle("active",_==="login"),E.classList.toggle("active",_==="signup"),A.textContent=_==="login"?"Sign In":"Sign Up",S.style.display="none"};x.addEventListener("click",()=>R("login")),E.addEventListener("click",()=>R("signup")),q.addEventListener("submit",async _=>{_.preventDefault(),S.style.display="none";const F=w.value.trim(),W=L.value;if(!F||!W){S.textContent="Please enter email and password.",S.style.display="block";return}A.disabled=!0,A.textContent=s==="login"?"Signing in...":"Signing up...";try{const B=await chrome.runtime.sendMessage({type:s==="login"?"SIGN_IN":"SIGN_UP",email:F,password:W});if(B!=null&&B.error)S.textContent=B.error,S.style.display="block";else{const O=await chrome.runtime.sendMessage({type:"CHECK_PREFERENCES"});O!=null&&O.hasPreferences?C():f()}}catch(B){S.textContent=B.message||"An error occurred.",S.style.display="block"}finally{A.disabled=!1,A.textContent=s==="login"?"Sign In":"Sign Up"}})},f=async()=>{i.style.display="flex",o.style.display="none";let s=null;try{const w=await chrome.runtime.sendMessage({type:"GET_PREFERENCES"});s=(w==null?void 0:w.preferences)||null}catch(w){console.error("Failed to load preferences:",w)}i.innerHTML=`
    ...
    `;const x=i.querySelector("#ss-preferences-form"),E=i.querySelector("#ss-pref-error"),q=i.querySelector("#ss-pref-submit");if(s){const w=i.querySelector("#ss-pref-price"),L=i.querySelector("#ss-pref-quality"),S=i.querySelector("#ss-pref-brand"),A=i.querySelector("#ss-pref-sustainability"),R=i.querySelector("#ss-pref-reviews"),_=i.querySelector("#ss-pref-innovation");w&&s.price_sensitivity&&(w.value=s.price_sensitivity),L&&s.quality_preference&&(L.value=s.quality_preference),S&&s.brand_preference&&(S.value=s.brand_preference),A&&s.sustainability&&(A.value=s.sustainability),R&&s.review_dependency&&(R.value=s.review_dependency),_&&s.innovation_adoption&&(_.value=s.innovation_adoption)}x.addEventListener("submit",async w=>{w.preventDefault(),E.style.display="none";const L={price:i.querySelector("#ss-pref-price").value||null,quality:i.querySelector("#ss-pref-quality").value||null,brand:i.querySelector("#ss-pref-brand").value||null,sustainability:i.querySelector("#ss-pref-sustainability").value||null,reviews:i.querySelector("#ss-pref-reviews").value||null,innovation:i.querySelector("#ss-pref-innovation").value||null};q.disabled=!0,q.textContent="Saving...";try{const S=await chrome.runtime.sendMessage({type:"SAVE_PREFERENCES",preferences:L});S!=null&&S.error?(E.textContent=S.error,E.style.display="block"):C()}catch(S){E.textContent=S.message||"An error occurred.",E.style.display="block"}finally{q.disabled=!1,q.textContent="Save Preferences"}})},C=()=>{i.style.display="none",o.style.display="flex"};l.addEventListener("click",async()=>{P("Analyzing..."),await chrome.runtime.sendMessage({type:"ANALYZE_CLICK"})}),r.addEventListener("submit",async s=>{s.preventDefault();const x=(z==null?void 0:z.value.trim())??"";!x||!I||(J(I,{role:"user",content:x}),z&&(z.value=""),await chrome.runtime.sendMessage({type:"CHAT_SEND",question:x}))}),z==null||z.addEventListener("keydown",s=>{s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),r.requestSubmit())}),a.addEventListener("click",()=>{f()});let h=!1;const g=n.querySelector("#ss-minimized-icon"),b=n.querySelector("#ss-close-mini"),T=n.querySelector("#ss-more-options-mini"),v=()=>{if(h=!h,h){if(d.classList.add("minimized"),c.title="Expand",p){const s=p.style.top||window.getComputedStyle(p).top||"16px";p.style.position="fixed",p.style.top=s,p.style.right="16px",p.style.left="auto",p.style.bottom="auto",p.style.width="80px",p.style.height="80px",p.style.margin="0",p.style.transform="none"}}else if(d.classList.remove("minimized"),c.title="Minimize",p){const s=p.style.top||window.getComputedStyle(p).top||"16px";p.style.position="fixed",p.style.top=s,p.style.right="16px",p.style.left="auto",p.style.bottom="auto",p.style.width="340px",p.style.height="calc(100vh - 32px)",p.style.margin="0",p.style.transform="none"}};c.addEventListener("click",s=>{s.stopPropagation(),v()}),g.addEventListener("click",s=>{s.stopPropagation(),h&&v()}),b.addEventListener("click",s=>{s.stopPropagation(),p&&(p.style.display="none")}),T.addEventListener("click",s=>{s.stopPropagation(),f()}),m()},ve=()=>{X(),p&&(p.style.display="block")},ge=()=>{if(X(),!p)return;const e=p.style.display==="none";p.style.display=e?"block":"none"},xe=()=>{const e=he();return console.log("[ShopSense] extracted",e),e};chrome.runtime.onMessage.addListener((e,t,n)=>e.type==="EXTRACT_REQUEST"?(n(xe()),!0):e.tabId&&G&&e.tabId!==G?!1:e.type==="TOGGLE_SIDEBAR"?(ge(),!0):(ve(),e.type==="STATUS"||e.type==="ERROR"?(P(e.message),!0):e.type==="ANALYZE_RESULT"&&Y?(be(Y,e.result),P("Analyze completed"),!0):e.type==="CHAT_RESPONSE"&&I?(J(I,e.message),P("Chat ready"),!0):!1));const we=async()=>{G=await ye()};we();
