const b=(e,t=document)=>{var n;for(const i of e){const r=t.querySelector(i),l=(n=r==null?void 0:r.textContent)==null?void 0:n.trim();if(l)return l}},k=e=>{var t;for(const n of e){const i=document.querySelector(`meta[name="${n}"], meta[property="${n}"]`),r=(t=i==null?void 0:i.getAttribute("content"))==null?void 0:t.trim();if(r)return r}},M=e=>{if(!e)return;const t=e.replace(/[^0-9.]/g,""),n=Number(t);return Number.isFinite(n)?n:void 0},D=e=>{if(!e)return;const t=e.replace(/,/g,"").match(/(\d+(\.\d+)?)/);return t?M(t[1]):void 0},H=(e,t="USD")=>e?e.includes("£")?"GBP":e.includes("€")?"EUR":e.includes("¥")?"JPY":e.includes("₩")?"KRW":e.includes("$")?"USD":t:t,Z=e=>e.replace(/[:：]\s*$/,"").trim(),U=(e,t,n)=>{const i=t?Z(t):"",r=(n==null?void 0:n.trim())??"";!i||!r||e[i]||(e[i]=r)},j=(e,t)=>{e.querySelectorAll("table").forEach(n=>{n.querySelectorAll("tr").forEach(i=>{var r,l;U(t,(r=i.querySelector("th"))==null?void 0:r.textContent,(l=i.querySelector("td"))==null?void 0:l.textContent)})}),e.querySelectorAll("dl").forEach(n=>{Array.from(n.querySelectorAll("dt")).forEach(r=>{var l;U(t,r.textContent,(l=r.nextElementSibling)==null?void 0:l.textContent)})}),e.querySelectorAll("li").forEach(n=>{const i=n.querySelector("span.a-text-bold, strong, b");if(!i)return;const r=i.textContent??"",l=Z(r);if(!l)return;const c=(n.textContent??"").replace(r,"").replace(/^[\s:-]+/,"").trim();U(t,l,c)})},$=(e=document)=>{const t={};return j(e,t),Object.keys(t).length>0?t:void 0},ee=["[itemprop=review]","[data-hook=review]",".review",".reviews-list .review-item","[data-testid=review-card]",".ugc-review-body"],V=(e=ee,t=document)=>{const n=[];return t.querySelectorAll(e.join(",")).forEach(i=>{var l;if(n.length>=5)return;const r=(l=i.textContent)==null?void 0:l.trim();r&&r.length>20&&n.push(r.replace(/\s+/g," "))}),n.length>0?n:void 0},te=()=>{var s;const e=k(["og:title","twitter:title"])||b(["h1","[itemprop=name]","[data-test=product-title]"])||document.title,t=k(["product:brand","og:brand"])||b(["[itemprop=brand]","[data-brand]",".brand",".product-brand"]),n=k(["product:mpn","product:model"])||b(["[itemprop=mpn]","[data-model]"]),i=k(["product:price:amount","price","og:price:amount"])||b(["[itemprop=price]","[data-test=product-price]",".price"]),r=k(["product:price:currency","price:currency"])||((s=document.querySelector("[itemprop=priceCurrency]"))==null?void 0:s.getAttribute("content"))||H(i,"USD"),l=k(["rating","ratingValue"])||b(["[itemprop=ratingValue]","[data-test=rating]",".rating"]),o=k(["reviewCount"])||b(["[itemprop=reviewCount]","[data-hook=total-review-count]",".review-count"]),c=M(i);return{title:e,brand:t,model:n,price:c!==void 0?{value:c,currency:r}:void 0,rating:D(l),review_count:M(o),key_specs:$(),visible_reviews:V()}},ie=e=>e&&e.replace(/^Brand:\s*/i,"").replace(/^Visit the\s*/i,"").replace(/\s*Store$/i,"").trim()||void 0,ne=()=>{const e={};["#productDetails_techSpec_section_1","#productDetails_detailBullets_sections1","#technicalSpecifications_feature_div","#detailBullets_feature_div","#detailBulletsWrapper_feature_div","#prodDetails"].forEach(i=>{const r=document.querySelector(i);r&&j(r,e)});const n=$();return n&&Object.entries(n).forEach(([i,r])=>{e[i]||(e[i]=r)}),Object.keys(e).length>0?e:void 0},oe=()=>b(["#mir-layout-DELIVERY_BLOCK-slot-PRIMARY_DELIVERY_MESSAGE_LARGE","#mir-layout-DELIVERY_BLOCK-slot-DELIVERY_MESSAGE","#deliveryMessageMirId","#deliveryMessage","#mir-layout-DELIVERY_BLOCK-slot-PRIMARY_DELIVERY_MESSAGE_SMALL"]),re=()=>{const e=b(["#productTitle","h1#title"]),t=document.querySelector("#bylineInfo"),n=ie((t==null?void 0:t.getAttribute("aria-label"))??(t==null?void 0:t.textContent)??""),i=b(["#corePrice_feature_div .a-offscreen","#apex_desktop .a-price .a-offscreen","#priceblock_ourprice","#priceblock_dealprice","#priceblock_saleprice"])??k(["product:price:amount","price","og:price:amount"]),r=M(i),l=k(["product:price:currency","price:currency"])||H(i,"USD"),o=document.querySelector("#acrPopover"),c=(o==null?void 0:o.getAttribute("title"))||(o==null?void 0:o.textContent)||b(["#averageCustomerReviews .a-icon-alt","span[data-hook=rating-out-of-text]"]),s=b(["#acrCustomerReviewText","span[data-hook=total-review-count]"]),d=ne(),m=(d==null?void 0:d["Item model number"])||(d==null?void 0:d.Model)||b(["[itemprop=mpn]"]);return{title:e,brand:n,model:m,price:r!==void 0?{value:r,currency:l}:void 0,rating:D(c),review_count:M(s),key_specs:d,visible_reviews:V(["[data-hook=review-body]",".review-text","[data-hook=review]"]),shipping_returns:oe()}},se=()=>{var o;const e={},t=document.querySelector('[data-testid="brix-sheet"]');t&&t.querySelectorAll('div.inline-flex.w-full, div[class*="inline-flex"][class*="w-full"], div[class*="dB7j8sHUbncyf79K"]').forEach(s=>{var u,f;const d=s.querySelector('div.font-weight-medium, div[class*="font-weight-medium"]'),m=s.querySelector('div[class*="pl-300"], div.grow.basis-none[class*="pl-300"]');if(d&&m){const C=d.cloneNode(!0);C.querySelectorAll("button").forEach(T=>T.remove());let x=((u=C.textContent)==null?void 0:u.trim())||"";const y=((f=m.textContent)==null?void 0:f.trim())||"";x=x.replace(/\s+/g," ").trim(),x&&y&&x.length>0&&y.length>0&&(e[x]=y)}});const n=document.querySelectorAll("h2.h5");let i=null;for(const c of Array.from(n))if(((o=c.textContent)==null?void 0:o.trim())==="Highlights"){i=c;break}if(i){const c=i.parentElement;c&&c.querySelectorAll("button.c-button-unstyled").forEach(d=>{var u,f,C;const m=d.querySelector("div.flex.flex-column");if(m){const h=m.querySelector("div:first-child"),x=m.querySelector('div.font-500, div[class*="font-500"]');if(h&&x){const y=h.cloneNode(!0);y.querySelectorAll("svg").forEach(q=>q.remove());let g=((u=y.textContent)==null?void 0:u.trim())||"",a=((f=x.textContent)==null?void 0:f.trim())||"";const v=x.cloneNode(!0);v.querySelectorAll("svg").forEach(q=>q.remove()),a=((C=v.textContent)==null?void 0:C.trim())||"",g=g.replace(/\s+/g," ").trim(),a=a.replace(/\s+/g," ").trim(),g&&a&&g.length>0&&a.length>0&&(e[g]||(e[g]=a))}}})}["#specifications",".specifications",".specification-table",".product-data"].forEach(c=>{const s=document.querySelector(c);s&&j(s,e)});const l=$();return l&&Object.entries(l).forEach(([c,s])=>{e[c]||(e[c]=s)}),Object.keys(e).length>0?e:void 0},ae=()=>{var o,c,s,d;const e=document.querySelector('[data-component-name="FulfillmentSelector"]');if(!e)return b([".fulfillment-additional-info",".availabilityMessage",".fulfillment-fulfillment-summary"]);const t=[],n=e.querySelector('button[data-test-id="pickup"]');if(n){const u=(n.getAttribute("aria-label")||"").match(/(?:Ready on|Pickup)\s+([^,]+,\s*[^,]+)/i);if(u)t.push(`Pickup: ${u[1]}`);else{const f=(c=(o=n.querySelector("strong"))==null?void 0:o.textContent)==null?void 0:c.trim();f&&t.push(`Pickup: ${f}`)}}const i=e.querySelector('button[data-test-id="shipping"]');if(i){const u=(i.getAttribute("aria-label")||"").match(/(?:Get it by|Shipping)\s+([^,]+,\s*[^,]+)/i);if(u)t.push(`Shipping: ${u[1]}`);else{const f=(d=(s=i.querySelector("strong"))==null?void 0:s.textContent)==null?void 0:d.trim();f&&t.push(`Shipping: ${f}`)}}const l=(e.textContent||"").match(/Order now for pickup on ([^a]+) at\s+([^<]+)/i);return l&&t.push(`Pickup location: ${l[2].trim()}`),t.length>0?t.join(" - "):void 0},ce=()=>{var f,C,h,x,y,T;const e=b([".sku-title h1","h1.sku-title","h1"]);let t;const n=document.querySelector('[data-component-name="ProductHeader"]');if(n){const g=n.querySelector(".description a");t=(f=g==null?void 0:g.textContent)==null?void 0:f.trim()}let i;if(n){const g=n.querySelector(".disclaimer");if(g){const v=(g.textContent||"").match(/Model:\s*([^\s]+)/i);v&&(i=v[1])}}let r;const l=document.querySelector('[data-testid="price-block-customer-price"]');l&&(r=(C=l.textContent)==null?void 0:C.trim()),r||(r=b([".priceView-hero-price span",".priceView-customer-price span","[data-testid=customer-price]",".pricing-price__regular-price"])??k(["product:price:amount","price","og:price:amount"]));const o=M(r),c=k(["product:price:currency","price:currency"])||H(r,"USD");let s,d;const m=document.querySelector('[data-component-name="ReviewStatsContextualized"]');if(m){const g=m.querySelector("span.font-weight-bold");if(s=(h=g==null?void 0:g.textContent)==null?void 0:h.trim(),!s){const w=(((x=m.querySelector("p.visually-hidden"))==null?void 0:x.textContent)||"").match(/Rating\s+(\d+(?:\.\d+)?)\s+out\s+of/i);w&&(s=w[1])}const a=m.querySelector("span.c-reviews"),E=(((y=a==null?void 0:a.textContent)==null?void 0:y.trim())||"").match(/(\d+)\s*review/i);if(E&&(d=E[1]),!d){const w=(((T=m.querySelector("p.visually-hidden"))==null?void 0:T.textContent)||"").match(/(\d+)\s+review/i);w&&(d=w[1])}}s||(s=b([".c-review-average",".ugc-c-review-average","[data-automation=overall-rating]"])),d||(d=b([".c-review-count",".ugc-c-review-count","[data-automation=review-count]"]));const u=se();return t=t||(u==null?void 0:u.Brand)||(u==null?void 0:u["Brand Name"]),i=i||(u==null?void 0:u.Model)||(u==null?void 0:u["Model Number"]),{title:e,brand:t,model:i,price:o!==void 0?{value:o,currency:c}:void 0,rating:D(s),review_count:M(d),key_specs:u,visible_reviews:V(["[data-component-name=CustomerReviewListSection] #review-list li p","#review-list li p","[data-testid=enhanced-review-content]","[data-testid=review-card]",".ugc-review-body",".review-text",".review-item"]),shipping_returns:ae()}},le=()=>{const e={};["[data-testid=specifications-section]","[data-testid=product-specifications]","#product-specifications","#specifications"].forEach(i=>{const r=document.querySelector(i);r&&j(r,e)});const n=$();return n&&Object.entries(n).forEach(([i,r])=>{e[i]||(e[i]=r)}),Object.keys(e).length>0?e:void 0},de=()=>{var s,d,m;const e=document.querySelector("#fulfillment-Shipping-content");if(!e)return;const t=[],n=e.querySelector('[data-seo-id="fulfillment-shipping-intent"]'),i=(s=n==null?void 0:n.textContent)==null?void 0:s.trim();i&&t.push(i);const r=n==null?void 0:n.nextElementSibling,l=(d=r==null?void 0:r.textContent)==null?void 0:d.trim();l&&l!==i&&t.push(l);const o=e.querySelector(".f7.b.green, .f7.b"),c=(m=o==null?void 0:o.textContent)==null?void 0:m.trim();return c&&t.push(c),t.length>0?t.join(" - "):void 0},pe=()=>{const e=[];return document.querySelectorAll('[data-testid="enhanced-review-content"]').forEach(n=>{var c,s;if(e.length>=5)return;const i=n.querySelector("h3"),r=((c=i==null?void 0:i.textContent)==null?void 0:c.trim())||"",l=n.querySelector('p[tabindex="-1"]'),o=((s=l==null?void 0:l.textContent)==null?void 0:s.trim())||"";if(o&&o.length>20){const d=r?`${r}. ${o}`:o;e.push(d.replace(/\s+/g," "))}}),e.length>0?e:void 0},ue=()=>{var m,u,f;const e=b(["[data-testid=product-title]","h1","[itemprop=name]"]),t=b(["[data-testid=brand-name]","[itemprop=brand]","a[data-testid=brand-name]","[data-automation-id=brand-name]"]),n=b(["[data-testid=price-wrap] [itemprop=price]","[data-testid=price-wrap]","[data-testid=price]","[itemprop=price]","[data-automation-id=product-price]"])??k(["product:price:amount","price","og:price:amount"]),i=M(n),r=k(["product:price:currency","price:currency"])||H(n,"USD"),l=document.querySelector('[data-testid="reviews-and-ratings"]');let o,c;if(l){const C=l.querySelector("span.w_iUH7");if(C){const h=((m=C.textContent)==null?void 0:m.trim())||"",x=h.match(/(\d+\.?\d*)\s*stars?/i);x&&(o=x[1]);const y=h.match(/(\d+(?:,\d+)?)\s*reviews?/i);y&&(c=y[1])}if(!o){const h=l.querySelector("span.f7"),y=(((u=h==null?void 0:h.textContent)==null?void 0:u.trim())||"").match(/\((\d+\.?\d*)\)/);y&&(o=y[1])}if(!c){const h=l.querySelector('[itemprop="ratingCount"]'),y=(((f=h==null?void 0:h.textContent)==null?void 0:f.trim())||"").match(/(\d+(?:,\d+)?)/);y&&(c=y[1])}}o||(o=b(["[data-testid=reviews-rating]","[itemprop=ratingValue]",".stars-container"])),c||(c=b(["[data-testid=reviews-header]","[data-testid=reviews-count]","[itemprop=reviewCount]",".stars-reviews-count"]));const s=le(),d=(s==null?void 0:s.Model)||(s==null?void 0:s["Model Number"]);return{title:e,brand:t,model:d,price:i!==void 0?{value:i,currency:r}:void 0,rating:D(o),review_count:M(c),key_specs:s,visible_reviews:pe()||V(["[data-testid=review-card]","[data-testid=review-text]","[data-testid=review-body]",".review-text",".prod-ProductReview",".review-body","[data-automation-id=review-text]","section[data-testid=reviews-section] [data-testid=review-card]"]),shipping_returns:de()}},me=e=>{const t=e.toLowerCase();return t.includes("amazon.")?re:t.includes("walmart.")?ue:t.endsWith("bestbuy.com")?ce:null},fe=(e,t)=>{var i;const n={...e.key_specs??{},...t.key_specs??{}};return{page_url:location.href,store_domain:location.host,title:t.title??e.title,brand:t.brand??e.brand,model:t.model??e.model,price:t.price??e.price,rating:t.rating??e.rating,review_count:t.review_count??e.review_count,key_specs:Object.keys(n).length>0?n:void 0,visible_reviews:(i=t.visible_reviews)!=null&&i.length?t.visible_reviews:e.visible_reviews,shipping_returns:t.shipping_returns??e.shipping_returns}},he=()=>{const e=te(),t=me(location.host),n=t?t():{};return fe(e,n)};function be(e){if(!e||typeof e!="string")return"";const t=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),n=[],i=/\[([^\]]+)\]\((https?:\/\/[^)]+)\)/g;let r=0,l;for(;(l=i.exec(e))!==null;)n.push(t(e.slice(r,l.index)).replace(/\n/g,"<br>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>")),n.push(`<a href="${t(l[2])}" target="_blank" rel="noreferrer noopener">${t(l[1])}</a>`),r=i.lastIndex;return n.push(t(e.slice(r)).replace(/\n/g,"<br>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>")),n.join("")}const Q="shopsense-sidebar";let G=null,N=null,K=null,Y=null,I=null,_=null,p=null;const ye=async()=>{try{const e=await chrome.runtime.sendMessage({type:"GET_TAB_ID"});if(typeof(e==null?void 0:e.tabId)=="number")return e.tabId}catch{}return null},P=e=>{if(!K||!N)return;K.textContent=e,N.classList.remove("busy","error");const t=e.toLowerCase();t.includes("fail")||t.includes("error")?N.classList.add("error"):(t.includes("analyz")||t.includes("send"))&&N.classList.add("busy")},ge=(e,t)=>{var i,r,l;e.innerHTML="";const n=document.createElement("p");if(n.textContent=t.summary??"No summary available.",e.appendChild(n),t.price){const o=document.createElement("div");o.className="meta-row",o.textContent=`Price: ${t.price.value} ${t.price.currency}`,e.appendChild(o)}if(t.rating!==void 0){const o=document.createElement("div");o.className="meta-row",o.textContent=`Rating: ${t.rating}`,e.appendChild(o)}if(t.review_count!==void 0){const o=document.createElement("div");o.className="meta-row",o.textContent=`Reviews: ${t.review_count}`,e.appendChild(o)}if((i=t.key_points)!=null&&i.length){const o=document.createElement("ul");t.key_points.forEach(c=>{const s=document.createElement("li");s.textContent=c,o.appendChild(s)}),e.appendChild(o)}if(t.specs&&Object.keys(t.specs).length>0){const o=document.createElement("div");o.className="specs",Object.entries(t.specs).forEach(([c,s])=>{const d=document.createElement("div");d.className="spec-row",d.textContent=`${c}: ${s}`,o.appendChild(d)}),e.appendChild(o)}if((r=t.citations)!=null&&r.length){const o=document.createElement("div");o.className="citations",t.citations.forEach(c=>{const s=document.createElement("a");s.href=c.url,s.target="_blank",s.rel="noreferrer",s.textContent=c.title??c.url,o.appendChild(s)}),e.appendChild(o)}if((l=t.suggested_questions)!=null&&l.length){const o=document.createElement("div");o.className="suggested-questions",t.suggested_questions.forEach(c=>{const s=document.createElement("button");s.type="button",s.className="suggested-question-btn",s.textContent=c,s.style.display="block",s.style.width="100%",s.style.textAlign="left",s.style.padding="0.5rem 0.75rem",s.style.marginBottom="0.35rem",s.style.cursor="pointer",s.style.border="1px solid #e0e0e0",s.style.borderRadius="4px",s.style.background="#f5f5f5",s.style.fontSize="0.9rem",s.addEventListener("click",()=>{chrome.runtime.sendMessage({type:"CHAT_SEND",question:c})}),o.appendChild(s)}),e.appendChild(o)}},J=(e,t)=>{var r;const n=document.createElement("div");n.className=`chat-message ${t.role}`;const i=document.createElement("div");if(i.className="chat-text",i.innerHTML=be(t.content),n.appendChild(i),(r=t.citations)!=null&&r.length){const l=document.createElement("div");l.className="chat-citations",t.citations.forEach(o=>{const c=document.createElement("a");c.href=o.url,c.target="_blank",c.rel="noreferrer",c.textContent=o.title??o.url,l.appendChild(c)}),n.appendChild(l)}e.appendChild(n),e.scrollTop=e.scrollHeight},X=()=>{if(p)return;const e=document.getElementById(Q);if(e){p=e;return}const t=document.createElement("div");t.id=Q,t.style.position="fixed",t.style.top="16px",t.style.right="16px",t.style.left="auto",t.style.bottom="auto",t.style.margin="0",t.style.transform="none",t.style.width="340px",t.style.height="calc(100vh - 32px)",t.style.zIndex="2147483647",t.style.display="none";const n=t.attachShadow({mode:"open"});n.innerHTML=`
    <style>
      :host { all: initial; }
  ...
  `,document.documentElement.appendChild(t),p=t,N=n.querySelector("#ss-status-dot"),K=n.querySelector("#ss-status-text"),Y=n.querySelector("#ss-analyze"),I=n.querySelector("#ss-chat"),_=n.querySelector("#ss-chat-input");const i=n.querySelector("#ss-auth-container"),r=n.querySelector("#ss-main-content"),l=n.querySelector("#ss-analyze-btn"),o=n.querySelector("#ss-chat-form"),c=n.querySelector("#ss-settings-btn"),s=n.querySelector("#ss-minimize-btn"),d=n.querySelector("#ss-sidebar"),m=async()=>{try{const a=await chrome.runtime.sendMessage({type:"CHECK_AUTH"});if(a!=null&&a.isAuthenticated){const v=await chrome.runtime.sendMessage({type:"CHECK_PREFERENCES"});v!=null&&v.hasPreferences?C():f()}else u()}catch(a){console.error("Auth check failed:",a),u()}},u=()=>{i.style.display="flex",r.style.display="none",i.innerHTML=`
    ...
    `;let a="login";const v=i.querySelector('[data-mode="login"]'),E=i.querySelector('[data-mode="signup"]'),q=i.querySelector("#ss-auth-form"),w=i.querySelector("#ss-auth-email"),L=i.querySelector("#ss-auth-password"),S=i.querySelector("#ss-auth-error"),A=i.querySelector("#ss-auth-submit"),R=z=>{a=z,v.classList.toggle("active",z==="login"),E.classList.toggle("active",z==="signup"),A.textContent=z==="login"?"Sign In":"Sign Up",S.style.display="none"};v.addEventListener("click",()=>R("login")),E.addEventListener("click",()=>R("signup")),q.addEventListener("submit",async z=>{z.preventDefault(),S.style.display="none";const F=w.value.trim(),W=L.value;if(!F||!W){S.textContent="Please enter email and password.",S.style.display="block";return}A.disabled=!0,A.textContent=a==="login"?"Signing in...":"Signing up...";try{const B=await chrome.runtime.sendMessage({type:a==="login"?"SIGN_IN":"SIGN_UP",email:F,password:W});if(B!=null&&B.error)S.textContent=B.error,S.style.display="block";else{const O=await chrome.runtime.sendMessage({type:"CHECK_PREFERENCES"});O!=null&&O.hasPreferences?C():f()}}catch(B){S.textContent=B.message||"An error occurred.",S.style.display="block"}finally{A.disabled=!1,A.textContent=a==="login"?"Sign In":"Sign Up"}})},f=async()=>{i.style.display="flex",r.style.display="none";let a=null;try{const w=await chrome.runtime.sendMessage({type:"GET_PREFERENCES"});a=(w==null?void 0:w.preferences)||null}catch(w){console.error("Failed to load preferences:",w)}i.innerHTML=`
    ...
    `;const v=i.querySelector("#ss-preferences-form"),E=i.querySelector("#ss-pref-error"),q=i.querySelector("#ss-pref-submit");if(a){const w=i.querySelector("#ss-pref-price"),L=i.querySelector("#ss-pref-quality"),S=i.querySelector("#ss-pref-brand"),A=i.querySelector("#ss-pref-sustainability"),R=i.querySelector("#ss-pref-reviews"),z=i.querySelector("#ss-pref-innovation");w&&a.price&&(w.value=a.price),L&&a.quality&&(L.value=a.quality),S&&a.brand&&(S.value=a.brand),A&&a.sustainability&&(A.value=a.sustainability),R&&a.reviews&&(R.value=a.reviews),z&&a.innovation&&(z.value=a.innovation)}v.addEventListener("submit",async w=>{w.preventDefault(),E.style.display="none";const L={price:i.querySelector("#ss-pref-price").value||null,quality:i.querySelector("#ss-pref-quality").value||null,brand:i.querySelector("#ss-pref-brand").value||null,sustainability:i.querySelector("#ss-pref-sustainability").value||null,reviews:i.querySelector("#ss-pref-reviews").value||null,innovation:i.querySelector("#ss-pref-innovation").value||null};q.disabled=!0,q.textContent="Saving...";try{const S=await chrome.runtime.sendMessage({type:"SAVE_PREFERENCES",preferences:L});S!=null&&S.error?(E.textContent=S.error,E.style.display="block"):C()}catch(S){E.textContent=S.message||"An error occurred.",E.style.display="block"}finally{q.disabled=!1,q.textContent="Save Preferences"}})},C=()=>{i.style.display="none",r.style.display="flex"};l.addEventListener("click",async()=>{P("Analyzing..."),await chrome.runtime.sendMessage({type:"ANALYZE_CLICK"})}),o.addEventListener("submit",async a=>{a.preventDefault();const v=(_==null?void 0:_.value.trim())??"";!v||!I||(J(I,{role:"user",content:v}),_&&(_.value=""),await chrome.runtime.sendMessage({type:"CHAT_SEND",question:v}))}),_==null||_.addEventListener("keydown",a=>{a.isComposing||a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),o.requestSubmit())}),c.addEventListener("click",()=>{f()});let h=!1;const x=n.querySelector("#ss-minimized-icon"),y=n.querySelector("#ss-close-mini"),T=n.querySelector("#ss-more-options-mini"),g=()=>{if(h=!h,h){if(d.classList.add("minimized"),s.title="Expand",p){const a=p.style.top||window.getComputedStyle(p).top||"16px";p.style.position="fixed",p.style.top=a,p.style.right="16px",p.style.left="auto",p.style.bottom="auto",p.style.width="80px",p.style.height="80px",p.style.margin="0",p.style.transform="none"}}else if(d.classList.remove("minimized"),s.title="Minimize",p){const a=p.style.top||window.getComputedStyle(p).top||"16px";p.style.position="fixed",p.style.top=a,p.style.right="16px",p.style.left="auto",p.style.bottom="auto",p.style.width="340px",p.style.height="calc(100vh - 32px)",p.style.margin="0",p.style.transform="none"}};s.addEventListener("click",a=>{a.stopPropagation(),g()}),x.addEventListener("click",a=>{a.stopPropagation(),h&&g()}),y.addEventListener("click",a=>{a.stopPropagation(),p&&(p.style.display="none")}),T.addEventListener("click",a=>{a.stopPropagation(),f()}),m()},xe=()=>{X(),p&&(p.style.display="block")},ve=()=>{if(X(),!p)return;const e=p.style.display==="none";p.style.display=e?"block":"none"},we=()=>{const e=he();return console.log("[ShopSense] extracted",e),e};chrome.runtime.onMessage.addListener((e,t,n)=>{if(e.type==="EXTRACT_REQUEST")return n(we()),!0;const i="tabId"in e?e.tabId:void 0;return i!=null&&G!=null&&i!==G?!1:e.type==="TOGGLE_SIDEBAR"?(ve(),!0):(xe(),e.type==="STATUS"||e.type==="ERROR"?(P(e.message),!0):e.type==="ANALYZE_RESULT"&&Y?(ge(Y,e.result),P("Analyze completed"),!0):e.type==="CHAT_RESPONSE"&&I?(J(I,e.message),P("Chat ready"),!0):!1)});const Se=async()=>{G=await ye()};Se();
