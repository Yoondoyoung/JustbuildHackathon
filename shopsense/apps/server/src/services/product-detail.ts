import { buildProductDetailParams, serpSearch } from "../connectors/serpapi";
import type { ProductDetailResponse, ReviewItem } from "../types/search";
...
function extractReviews(data: Record<string, unknown>): ReviewItem[] {
  ...
  const possibleKeys = ["reviews", "top_reviews", "customer_reviews", "review_results"];
...
export async function fetchProductDetail(
  ...
  const metaUrl =
    meta && typeof meta.amazon_product_url === "string" ? String(meta.amazon_product_url).trim() : "";
